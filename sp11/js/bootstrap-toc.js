...
(function($) {
  ...
  window.Toc = {
    helpers: {
      ...
      // appends a <ul class="nav"> to the named element
	...
	var tertiaryLevel = secondaryLevel + 1;
    ...
    init: function(opts) {
      ...
      // $topContext is the <ul> generated as a child of the nav element 
      var $topContext = this.helpers.createChildNavList(opts.$nav);
      // topLevel is the highest heading in the toc
